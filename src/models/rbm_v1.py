...
class RBM(nn.Module):
    ...
    def train_rbm(
        ...
        Returns:
            ...
            and 'recon_error_features' if record_metrics is True. Otherwise, returns None.
        """
        ...
        if record_metrics:
            history = {"epoch": [], "avg_free_energy": [], "recon_error_features": []}
        ...
        for epoch in training_loop:
            ...
            if (
                ...
                history["recon_error_features"].append(avg_recon_error)
